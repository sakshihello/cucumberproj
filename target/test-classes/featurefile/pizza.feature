Feature: pizzahut url scenario
@Smoke
Scenario Outline:  Pizzahut pizza order flow
Given  launch Pizzahut application with <URL>
...
Examples:
        |URL|Location|
 |https://www.pizzahut.co.in/|LuLu Mall Hyderabad| 
